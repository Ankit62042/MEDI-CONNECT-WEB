      ...
      try {
        ...
        if (res.ok) {
          if (result.url) {
            ...
            toast.error("Error uploading image: URL not found in response");
            console.error("Upload response:", result);
          }
        } else {
          toast.error(`Error uploading image: ${result.error?.message || "Unknown error"}`);
    ...
    try {
      ...
      await toast.promise(
        axios.post("/user/register", {
          ...
          email,
          password,
          pic: file || "", // Use the uploaded file URL or an empty string if upload failed
        }),
        {
